...
public interface CalcPrecoPrazoWSSoap {
     ...
     */
    @WebMethod(operationName = "CalcPrazoObjeto", action = "http://tempuri.org/CalcPrazoObjeto")
    @WebResult(name = "CalcPrazoObjetoResult", targetNamespace = "http://tempuri.org/")
    @RequestWrapper(localName = "CalcPrazoObjeto", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.CalcPrazoObjeto")
    @ResponseWrapper(localName = "CalcPrazoObjetoResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.CalcPrazoObjetoResponse")
