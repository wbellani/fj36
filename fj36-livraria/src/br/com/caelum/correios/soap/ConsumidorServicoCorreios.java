...
public class ConsumidorServicoCorreios<CalcPrecoPrazoWSSoap, CResultado, CServico> {
	...
	public BigDecimal calculaFrete(String cepDestino) {
		...
		br.com.caelum.correios.soap.CalcPrecoPrazoWSSoap servico =  new CalcPrecoPrazoWS().getCalcPrecoPrazoWSSoap();

		br.com.caelum.correios.soap.CResultado resultado = servico.calcPrecoPrazo(semCodigoEmpresa, semSenhaEmpresa, codigoSedex, cepOrigemCaelumSP,
		...
		List<br.com.caelum.correios.soap.CServico> servicosPesquisados = resultado.getServicos().getCServico();
